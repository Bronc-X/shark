...
- One-click post-production: "一键生成字幕和旁白" must generate per-segment voiceover, render the final subtitle/voiceover MP4, mark the current project as `完成`, keep the final local MP4 in the preview after refresh, and expose a re-edit control for regenerating the final video.
